...
namespace ApiAccounts.Controllers
{
    public class AccountsController : ApiController
    {
        ...
        {
            Accounts accounts = dbAppApaymenstsContext.Accounts.Find(id);
            if (accounts == null)
            {
        ...
        public IHttpActionResult PostAccounts(Accounts accounts)
        {
            ...
            dbAppApaymenstsContext.Accounts.Add(accounts);
        ...
        public IHttpActionResult DeleteAccounts(Guid id)
        {
            ...
            dbAppApaymenstsContext.Accounts.Remove(accounts);
            dbAppApaymenstsContext.SaveChanges();
        ...
        {
            return dbAppApaymenstsContext.Accounts.Count(e => e.id_account == id) > 0;
        }
    }
}